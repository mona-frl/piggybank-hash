                        ...
                        case 1 -> {
                            ...
                            switch (currency) {
                                ...
                                case 1 -> {
                                    ...
                                    value = kb.nextDouble();
                                    piggybank.add(real, value);
                                }
                                case 2 -> {
                                    System.out.println("How much would you like to add?");
                                    value = kb.nextDouble();
                                    piggybank.add(euro, value);
                                }
                                case 3 -> {
                                    System.out.println("How much would you like to add?");
                                    value = kb.nextDouble();
                                    piggybank.add(dolar, value);
                                }
                        ...
                        case 2 -> {
                            ...
                            switch (currency) {
                                case 1 -> {
                                    ...
                                    value = kb.nextDouble();
                                    piggybank.remove(real, value);
                                }
                                case 2 -> {
                                    System.out.println("How much would you like to remove?");
                                    value = kb.nextDouble();
                                    piggybank.remove(euro, value);
                                }
                                case 3 -> {
                                    System.out.println("How much would you like to remove?");
                                    value = kb.nextDouble();
                                    piggybank.remove(dolar, value);
                                }
                                default -> System.out.println("Invalid option.\n");
                            }
                        }
